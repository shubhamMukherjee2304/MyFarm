  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      <p className='text-sm self-center'>
        {/* <span className='text-slate-700'>Upload an image (image size less than 2MB only)</span> */}
        {
    ...
    {userListings && userListings.length > 0 &&
      ...
      <div className='flex flex-col gap-4'>
        <h1 className='text-center mt-7 text-2xl font-semibold'>Ur listing</h1>

      {userListings.map((listing) => (
      <div key={listing._id} className='border rounded-lg p-3 flex justify-betweeen items-center gap-4'>
